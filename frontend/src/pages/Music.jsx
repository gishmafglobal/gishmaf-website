  ...
  return (
    ...
    >
      ...
      >
        <h3>🎵 Understanding Music Genres</h3>
        <p>
          Music comes in different styles known as genres. Each genre has its own sound and rhythm.
        </p>
        <p>
          <strong>Afrobeat</strong> blends African rhythms with jazz and funk. <br />
          <strong>Jazz</strong> focuses on improvisation. <br />
          <strong>Gospel</strong> is rooted in Christian worship. <br />
          <strong>Hip-Hop</strong> combines rap and storytelling. <br />
          <strong>Classical</strong> uses orchestral instruments.
        </p>
      </div>
